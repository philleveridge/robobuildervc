...
RobobuilderLib.vectors.bcheck(int[], byte[], byte[]) 
RobobuilderLib.vectors.compare(int[], int[]) 
...
RobobuilderLib.vectors.scale(double[], double[], double) 
RobobuilderLib.vectors.str(int[]) 
